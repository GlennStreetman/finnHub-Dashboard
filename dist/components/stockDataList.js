...
class StockDataList extends React.Component {
    ...
    createDataList() {
        ...
        if (this.props.rFilteredStocks !== undefined) {
            ...
            const stockListKey = availableStocks.map((el) => (React.createElement("option", { key: el + "op", value: el }, el)));
            return stockListKey;
        }
    }
    render() {
        // console.log("rendering");
        return React.createElement(React.Fragment, null, this.createDataList());
    }
}
...
//# sourceMappingURL=stockDataList.js.map