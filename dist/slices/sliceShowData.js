        ...
        [tGetFinnhubData.fulfilled]: (state, action) => {
            ...
            for (const key in ap) {
                if (ap[key].dashboard === state.targetDashboard) {
                    ...
                    const widgetRef = ap[key].widget;
                    const security = ap[key].security;
...
rBuildVisableData, 
// rResetVisableData,
rSetTargetDashboard, } = showData.actions;
export default showData.reducer;
//# sourceMappingURL=sliceShowData.js.map