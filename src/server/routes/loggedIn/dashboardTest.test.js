...
beforeAll((done) => {
    ...
    VALUES (	
        'accountDashboardTest@test.com','${sha512("testpw")}',
        '',	'',	true,	
        'US',	'US',	30	
    )
    ...
    VALUES (
        (SELECT id FROM users WHERE email = 'accountDashboardTest@test.com'),
        'TEST', 
    ...
    VALUES (
            (SELECT id FROM dashboard WHERE userid = (SELECT id FROM users where email = 'accountDashboardTest@test.com') AND dashboardname = 'TEST' )
    ...
    VALUES (
        (SELECT id FROM menuSetup WHERE userid = (SELECT id FROM users WHERE email = 'accountDashboardTest@test.com')),
