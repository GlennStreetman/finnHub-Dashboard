...
router.post("/register", (req, res) => {
  // console.log(req.body)
    ...
    if (emailIsValid(emailText) === true && validateInfo() === true) {
        ...
        .then((data) => {
            const registrationMessage = process.env.EMAIL === 'true' ? "Thank you for registering, please check your email and follow the confirmation link." : "Thank you for registering. You can now login."
