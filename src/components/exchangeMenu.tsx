...
export default function ExchangeMenu(p) {
    ...
    const rExchangeList = useSelector(
        (state) => state.exchangeList.exchangeList
    );
    ...
    function changeExchange(ex) {
        ...
        fetch("/api/accountData", options)
            ...
            .then((data) => {
                dispatch(
                    rUpdateExchangeList({ exchangeList: newExchangeList })
                );
            });
    }
                ...
                <Grid item xs={12} sm={8} md={6} lg={4} xl={4}>
                    <TableContainer>
                        ...
                        >
                            ...
                            <TableBody>{exchangeListRows()}</TableBody>
                        </Table>
                        <TablePagination
