...
// }
class StockSearchPane extends React.PureComponent<props> {
    constructor(props) {
        super(props);
        this.state = {
    ...
    changeDefault(event) {
        ...
        this.props.updateAppState({ defaultExchange: event.target.value })
            ...
            <div className="stockSearch" data-testid={`stockSearchPane-${p.widgetType}`}>
                <form
                    ...
                    onSubmit={(e) => { //submit stock to be added/removed from global & widget stocklist.
                        ...
                        } else if (typeof widgetKey === 'number' && this.props.rUpdateStock !== undefined) { //Not menu widget. Menus named, widgets numbered.
                            // console.log('ADDING SECURITY TO WIDGET: ', this.props.rUpdateStock)
                            const thisStock = this.props.rUpdateStock
                            const stockKey = thisStock.key
