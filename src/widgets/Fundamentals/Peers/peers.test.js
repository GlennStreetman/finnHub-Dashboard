...
//mock routes
import { mockFinnHubData, getDashboard_success, mockExchangeData, mockFinnHubData_toggle } from "./peers.mock"; //if premium route add checkLogin override to .mock.ts file.
...
const widgetType = "FundamentalsPeers";
const body = "body-peersBody";
...
beforeEach(async () => {
    ...
    await addWidget("Stock Fundamentals", "Peers", body); //mount widget to be tested.
});
