...
//mock routes
import {mockFinnHubData, getDashboard_success, mockExchangeData, mockFinnHubData_toggle, } from './newsSentiment.mock' //if premium route add checkLogin override to .mock.ts file.
...
const widgetType = 'FundamentalsNewsSentiment'
const body = 'newsSentimentBody'
...
beforeEach( async ()=>{
    ...
    await addWidget('estimatesDropdown', 'Fundamentals', 'News Sentiments') //mount widget to be tested.
})
