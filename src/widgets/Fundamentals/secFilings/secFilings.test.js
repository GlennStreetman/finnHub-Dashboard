...
beforeEach( async ()=>{
    ...
    await addWidget('estimatesDropdown', 'Fundamentals', 'SEC Filings') //mount widget to be tested.
})
...
// //mock routes
// import {mockFinnHubData, getDashboard_success, getCheckLogin_success, postFindMongoData_success_noData, postUpdateGQLFilters} from './secFilings.mock'
// import { getFinnDashData_noData, postFinnDashData_noSave }  from '../../../server/routes/mongoDB/finnHubData.mock'
// import { postDashboard_success_noWidgets } from '../../../server/routes/loggedIn/dashboard.mock'
// import { mockFinnHubDataQuote } from '../../../appFunctions/getStockPrices.mock'
// import { mockFinnhubDataStockSymbol } from '../../../slices/sliceExchangeData.mock'
...
// it('Test Single Widget dashboard : secFilings ', async (done) => {
...
//     await waitFor(() => {
//         expect(screen.getByTestId('SEC Filings')).toBeInTheDocument() //copy submenu text
//     })
//     expect(getByTestId('SEC Filings')).toBeInTheDocument() //copy submenu text
//     fireEvent.click(screen.getByTestId('SEC Filings')) //copy submenu text
//     //check widget is mounted
//     await waitFor(() => {
//         expect(screen.getByTestId('secFilingsBody')).toBeInTheDocument() //testID for widgets outer most div
//         //additional tests for widget body render.
//     })
//     // check that edit pane for widget renders and all buttons work
//     expect(screen.getByTestId('editPaneButton-FundamentalsSECFilings')).toBeInTheDocument() //update with widgetID
//     fireEvent.click(getByTestId('editPaneButton-FundamentalsSECFilings')) //update with widgetID
//     await waitFor(() => {
...
//     })
//     //unmount widget
//     expect(screen.getByTestId('removeWidget-FundamentalsSECFilings')).toBeInTheDocument()  //update with widgetID
//     fireEvent.click(screen.getByTestId('removeWidget-FundamentalsSECFilings')) //update with widgetID
//     await waitFor(() => {
//         expect(screen.queryByTestId('secFilingsBody')).toBe(null) //update widget body tag.
//     })
//     done()
// })
