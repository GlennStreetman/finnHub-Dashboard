...
//mock routes
import { mockFinnHubData, getDashboard_success, mockExchangeData, mockFinnHubData_toggle, getCheckLogin_success } from "./priceSplits.mock"; //if premium route add checkLogin override to .mock.ts file.
...
const widgetType = "PriceSplits";
const body = "container-splitsBody";
...
beforeEach(async () => {
    ...
    await addWidget("Stock Price", "Price Split", body); //mount widget to be tested.
});
