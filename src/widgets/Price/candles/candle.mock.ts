...
export const mockFinnHubData = //MOCK API REQUEST FOR THIS WIDGET. Remember to update api string on next line.
    rest.get("https://finnhub.io/api/v1/stock/candle*", (req, res, ctx) => {
    ...
    rest.get("/checkLogin", (req, res, ctx) => {
        ...
        return res(
            ...
            ctx.json({
                ...
                ratelimit: 25,
                apiAlias: 'alias',
                widgetsetup: '{"PriceCandles":true}', //UPDATE NEEDED IF premium feature. First item from topNavReg tuple.
                exchangelist: 'US,AS',
                defaultexchange: 'US'
            })
        )
