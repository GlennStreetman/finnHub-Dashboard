...
const body = "container-EstimatesRecommendationTrends";
...
beforeEach(async () => {
    ...
    await addWidget("Stock Estimates", "Recommendation Trends", "container-EstimatesRecommendationTrends"); //mount widget to be tested.
});
